...
// int ws_server_send_bin_all(char* msg,uint64_t len); // sends bin to all clients
...
int ws_server_send_bin_all_from_callback(char* msg,uint64_t len); // sends bin to all clients
